...
if(isset($_REQUEST['btn_submitr']))
{
	executeQuery("update post_grievance set gr_mem_details='".$_REQUEST['mem_res']."', status='Success' where gr_id='".$_REQUEST['gr_id_new']."'");
...
<?php
 ...
 $fetch=executeQuery("SELECT * FROM post_grievance where gr_id='".$_REQUEST['btn_submit']."'");
