 ...
 <div class="col-9"> 
           <div class="row" style="margin-top:10px;"> 
                    ...
                    <div class="col-2 offset-2 border" style="border-radius:500px; padding-top:20px; background:#F9F9F9; height:150px;">
                       ...
                       <?php
					   $sc=executeQuery("SELECT count(gr_id) as scount FROM post_grievance where std_user='".$_SESSION['user']."' AND status='Success'");
                     ...
                     <div class="col-2 offset-3 border" style="border-radius:500px; padding-top:20px;background:#F9F9F9;  height:150px;">
                       ...
                       <?php
					   $pc=executeQuery("SELECT count(gr_id) as pcount FROM post_grievance where std_user='".$_SESSION['user']."' AND status='Pending'");
...
<table class="table offset-1 border table-bordered">
                ...
                <?php
				 $fetch=executeQuery("SELECT * FROM post_grievance where std_user='".$_SESSION['user']."' ORDER BY gr_id DESC");
				 $sr_no=0;
